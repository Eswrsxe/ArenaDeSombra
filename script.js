...
function render(){
  ...
  el.playerAtk.textContent = statAtk(state.player); el.playerDef.textContent = statDef(state.player);
  el.playerCrit.textContent = statCrit(state.player) + '%'; el.playerEvasion.textContent = statEvasion(state.player) + '%';
